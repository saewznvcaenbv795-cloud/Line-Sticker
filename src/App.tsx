    ...
    try {
      ...
      for (let i = 0; i < extracted.length; i++) {
        ...
        if (isGrid2x2) {
          ...
          const { slice2x2Grid } = await import('./utils/imageProcessing');
